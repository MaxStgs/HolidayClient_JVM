...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2018-11-20T18:36:01.976Z[GMT]")public class OutDetails {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, comments, date, total, photo, idStatement);
  }
